...
main (int argc, char *argv[])
{
  ...
  lteHelper->SetHandoverAlgorithmAttribute ("TimeToTrigger", TimeValue (MilliSeconds (1000)));
...
// lteHelper->Attach (ueLteDevs, enbLteDevs);
  ...
  AnimationInterface anim ("LteOuput/handover-test-lte.xml");
  // anim.s
  // anim.SetConstantPosition(ueNodes.Get(0), 15.0, 10.0); 
